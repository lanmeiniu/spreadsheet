...
void MainWindow::about()
{
    QMessageBox::about(this, tr("About Spreadsheet"),
            tr("<h2>Spreadsheet 1.1</h2>"
               "<p>1.Before working every day, click [Set Database Name and Table] to connect to the database."
               "<p>2.Click on the [get data from MySQL] when searching for fixed assets."
               "<p>3.When the fixed asset corresponds to the generated two-dimensional code, please click [generate QRcode]"
               "<p>When the fixed assets account, please click [sweep work piece]"
              ));
}
